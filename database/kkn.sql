...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 22 Apr 2019 pada 05.56
...
CREATE TABLE `mahasiswa` (
  ...
  `esai` varchar(200) NOT NULL,
  `surat_perizinan` varchar(200) NOT NULL,
...
--
ALTER TABLE `dpl`
  ADD CONSTRAINT `dpl_ibfk_1` FOREIGN KEY (`id_admin`) REFERENCES `admin` (`id_admin`),
  ADD CONSTRAINT `dpl_ibfk_2` FOREIGN KEY (`id_peng_masy`) REFERENCES `pengabdian_masyarakat` (`id_peng_masy`),
  ADD CONSTRAINT `dpl_ibfk_3` FOREIGN KEY (`id_penelitian`) REFERENCES `penelitian` (`id_penelitian`);
