  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
          ...
          <form action="https://formspree.io/ryanlaksmana123@gmail.com" method="POST">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleFirstName">Nama Depan</label>
                  <input type="text" class="form-control" id="exampleFirstName" placeholder="Nama Depan" name="firstName" required>
                </div>
              </div>
              
              <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleLastName">Nama Belakang</label>
                  <input type="text" class="form-control" id="exampleLastName" placeholder="Nama Belakang" name="lastName" required>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <label for="exampleJaminanKesehatan">Jaminan Kesehatan</label>
              <input type="number" class="form-control" id="exampleJaminanKesehatan" placeholder="Jaminan Kesehatan" name="Jaminan Kesehatan">
            </div>
