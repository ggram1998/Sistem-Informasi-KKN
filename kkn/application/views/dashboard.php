			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="card">
                                    ...
                                    <div class="card-body">
                                        <button type="button" class="btn btn-link btn-lg btn-block"><a href="<?php echo base_url ('assets/assets/document/Buku-Pedoman-KKN.pdf')?>">Buku Pedoman KKN</a></button>
                                        <button type="button" class="btn btn-link btn-lg btn-block"><a href="<?php echo base_url ('assets/assets/document/PembekalanKKN.pptx')?>">Pembekalan KKN</a></button>
