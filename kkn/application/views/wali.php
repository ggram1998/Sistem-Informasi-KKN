        ...
        <div class="content mt-3">
			<div class="row">
                <div class="col-lg-12">
					<div class="card">
                            <div class="card-body">
                                <p class="text-muted m-b-15">Data diri Wali mahasiswa</p>
                               <table width="500">
									<tr height="30px">
										<td>Nama</td><td>Walyuo</td>
									</tr>
									<tr height="30px">
										<td>No Telepon</td><td>088808444412</td>
									</tr>
									<tr height="30px">
										<td>Alamat</td><td>Jl. korpri raya</td>
									</tr>
									<tr height="30px">
										<td>Hubungan</td><td>Orang tua</td>
									</tr>
								</table>
                            </div>
                        </div>
