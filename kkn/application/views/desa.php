			...
			<div class="row">
                <div class="col-lg-12">
					<div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted m-b-15">Ditempatkan dilokasi dan Dosen Pembimbing Lapangan Sebagai Berikut:</p>

                               <table width="500">
									<tr height="30px">
										<td>kabupaten</td><td>Tanggamus</td>
									</tr>
									<tr height="30px">
										<td>kecamatan</td><td>Air naningan</td>
									</tr>
									<tr height="30px">
										<td>desa</td><td>Sinar jaya</td>
									</tr>
									<tr height="30px">
										<td>jenis KKN</td><td>Kebangsaan</td>
									</tr>
								</table>
