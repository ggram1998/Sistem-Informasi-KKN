        ...
        <div class="content mt-3">
			<div class="row">
                <div class="col-lg-12">
					<div class="card">
                            <div class="card-body">
                                <p class="text-muted m-b-15">Data diri Mahasiswa</p>
                               <table width="500">
									<tr height="30px">
										<td>Nama</td><td>Luki Fabrianto</td>
									</tr>
									<tr height="30px">
										<td>NIM</td><td>13115002</td>
									</tr>
									<tr height="30px">
										<td>Jenis Kelamin</td><td>Pria</td>
									</tr>
									<tr height="30px">
										<td>Program Studi</td><td>Teknik Elektro</td>
									</tr>
									<tr height="30px">
										<td>Jurusan</td><td>SAINS</td>
									</tr>
									<tr height="30px">
										<td>Fakultas</td><td>SAINS</td>
									</tr>
									<tr height="30px">
										<td>Universitas</td><td>INSTITUT TEKNOLOGI SUMATERA</td>
									</tr>
								</table>
                            </div>
                        </div>
