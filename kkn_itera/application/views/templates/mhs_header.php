                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-id-badge"></i><a href="<?php echo base_url('User/profil'); ?>">Data Diri</a></li>
                            <li><i class="fa fa-id-card-o"></i><a href="<?php echo base_url('User/wali'); ?>">Wali Penanggung</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-building-o"></i><a href="<?php echo base_url('User/desa'); ?>">Profil Desa</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th-list"></i><a href="<?php echo base_url('User/rencana'); ?>">Rencana Kegiatan</a></li>
                            <li><i class="menu-icon fa fa-files-o"></i><a href="<?php echo base_url('User/akhir'); ?>">Laporan Akhir</a></li>
                            <li><i class="menu-icon fa fa-file-text-o"></i><a href="<?php echo base_url('User/harian'); ?>">Laporan Harian</a></li>
                            <li><i class="menu-icon fa fa-youtube-play"></i><a href="<?php echo base_url('User/vidio'); ?>">Laporan Vidio</a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href="<?php echo base_url('User/catatan'); ?>">Catatan Lapangan</a></li>
                            <li><i class="menu-icon ti-themify-logo"></i><a href="<?php echo base_url('User/aduan'); ?>">Aduan</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="<?php echo base_url('User/kuesioner'); ?>"> <i class="menu-icon fa fa-question"></i>Kuesioner </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
