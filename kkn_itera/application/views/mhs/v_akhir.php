                ...
                <div class="animated">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <strong class="card-title" v-if="headerText">Laporan Akhir</strong>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="mediumModalLabel">Input Laporan Akhir</h5>
                                ...
                                <div class="modal-body">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="file" id="file-input" name="file-input" class="form-control-file">
                                            ...
                                            <p><strong>Hanya perwakilan Kelompok saja yang mengumpulkan</strong></p>
                                        </div>
                                    </div>
                                </div>
