                ...
                <div class="animated">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <strong class="card-title" v-if="headerText">Laporan Harian</strong>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="mediumModalLabel">Input Laporan Harian</h5>
                                ...
                                <div class="modal-body">
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="file-input" class=" form-control-label">File input Log Book</label></div>
                                        <div class="col-12 col-md-9"><input type="file" id="file-input" name="file-input" class="form-control-file">
                                            ...
                                            <p><strong>Setiap mahasiswa wajib mengumpulkan laporan harian</strong></p>
                                        </div>
                                    </div>
                                </div>
