<div id="right-panel" class="right-panel">
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <li class="active">Lihat laporan Kegiatan</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="content mt-3">
        ...
        <?php foreach ($data->result_array() as $i) :
                       $nim=$i['nim'];
                       $nama=$i['nama'];
                       $laporan_harian=$i['laporan_harian'];
                  ...
                  <td style="text-align:right;">
                        ...
                        <a class="btn" href="<?php echo base_url().'dpl/laporan_harian/'.$laporan_harian;?>"><span class="fa fa-arrow-down"></span></a>
